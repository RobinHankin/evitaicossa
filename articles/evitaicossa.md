...
a vector space is a set $`V`$ of vectors which form an Abelian group
under addition and also satisfy the following axioms:
...
$`\mathbf{x}_1,\ldots,\mathbf{x}_n`$. These will be denoted generally by
a single letter, as in $`\mathbf{a},\mathbf{b},\ldots,\mathbf{z}`$. We
...
(where the sums run from $`1`$ to $`n`$), we define the sum $`A+B`$ to
be
...
structure of the object. This one has some single-symbol elements, some
double-symbol and some triple-symbol elements.
...
chose the latter because R idiom for multiplication is left associative:
...
Hankin, R. K. S. 2022a. *Clifford Algebra in R*. arXiv.
<https://doi.org/10.48550/ARXIV.2209.13659>.

Hankin, R. K. S. 2022b. *Disordered Vectors in R: Introducing the
`disordR` Package*. arXiv. <https://doi.org/10.48550/ARXIV.2210.03856>.

Hankin, R. K. S. 2022c. *Fast Multivariate Polynomials in R: The `mvp`
Package*. arXiv. <https://doi.org/10.48550/ARXIV.2210.15991>.

Hankin, R. K. S. 2022d. *Quantum Algebra in R: The Weyl Package*.
[Https://arxiv.org/abs/2212.09230](https://arxiv.org/abs/2212.09230);
arXiv. <https://doi.org/10.48550/ARXIV.2212.09230>.

Hankin, R. K. S. 2022e. *Sparse Arrays in R: The `spray` Package*.
arXiv. <https://doi.org/10.48550/ARXIV.2210.10848>.

Hankin, R. K. S. 2022f. *The Free Algebra in R*. arXiv.
...
Hankin, R. K. S. 2024. *Antiassociative Algebra in R: Introducing the
`evitaicossa` Package*. arXiv.
<https://doi.org/10.48550/arXiv.2412.16161>.
